		<p style="width:63%;float:left;">
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'miniloops' );?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title_url' ); ?>"><?php _e( 'Title URL:', 'miniloops' );?>
		...
		<h3><?php _e( 'Query', 'miniloops' ); ?></h3>
		<p style="width:48%;float:left;">
			<label for="<?php echo $this->get_field_id('number_posts'); ?>"><?php _e('Number of Posts:', 'miniloops' );?>
		...
		<p style="width:48%;float:right;">
			<label for="<?php echo $this->get_field_id('post_offset'); ?>"><?php _e('Posts Offset:', 'miniloops' );?>
		...
		<p style="width:48%;float:left;">
			<label for="<?php echo $this->get_field_id('post_type'); ?>"><?php _e('Post Type:', 'miniloops' );?>
		...
		<p style="width:48%;float:right;">
			<label for="<?php echo $this->get_field_id('post_status'); ?>"><?php _e('Post Status:', 'miniloops' );?>
		...
		<p style="width:48%;float:left;">
			<label for="<?php echo $this->get_field_id('order_by'); ?>"><?php _e('Order by:', 'miniloops' );?>
		...
		<p style="width:48%;float:right;">
			<label for="<?php echo $this->get_field_id('order'); ?>"><?php _e('Order:', 'miniloops' );?>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('shuffle_order'); ?>"><?php _e('Shuffle post order?', 'miniloops');?></label>
			<small>(<?php _e('ABC vs BCA', 'miniloops');?>)</small>
		</p>
		<p style="width:48%;float:left;">
		...
		<p style="width:48%;float:right;">
			...
			<label for="<?php echo $this->get_field_id('only_sticky'); ?>"><?php _e('Only sticky posts?', 'miniloops');?></label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('tax'); ?>"><?php _e('Custom Taxonomies:', 'miniloops');?>
				...
				<small>(<?php _e('Ex: category=1,2,4&post_tag=6,12', 'miniloops');?><br />
						<?php _e('Available: ', 'miniloops'); implode( ', ', get_taxonomies( array( 'public' => true ) ) ); ?>)</small>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('custom_fields'); ?>"><?php _e('Custom Fields:', 'miniloops');?>
				...
				<small>(<?php _e('Ex: meta_key=meta_value&meta_key2=meta_value2', 'miniloops');?>)</small>
			</label>
		</p>
		<p>
		...
		<h3 style="clear:both;"><?php _e( 'Format', 'miniloops' ); ?></h3>
		<p style="width:48%;float:left;">
		...
		<p>
			...
			<small><em><a href="http://wordpress.org/extend/plugins/mini-loops/other_notes/"><?php _e('Sweet beaver! What does this mean?!?', 'miniloops');?></a></em></small>
		</p>
